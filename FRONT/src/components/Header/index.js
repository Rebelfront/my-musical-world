...
import { AppBar, Avatar, Button, Container, Divider, IconButton, ListItemIcon, Menu, MenuItem, Toolbar, Tooltip, Typography } from '@mui/material';
  ...
  return (
    <AppBar className="header" position="sticky">
      <Container maxWidth="xl">
        ...
        >
          <Link className="header__brand" to="/">My Musical W<Avatar alt="site logo" src={logo}></Avatar>rld</Link>
        </Typography>
        {!isLogged ? (
          <Box sx={{ ml: 'auto' }}>
